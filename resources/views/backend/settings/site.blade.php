        ...
        <div class="card-body bg-gray-200">
            {{ Form::open(['route' => ['site-settings.update', $siteSetting->id], 'method' => 'PUT']) }}
                <div class="row mg-b-25">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            {{ Form::label('youtube', 'Youtube Link',['class' => 'form-control-label']) }}
                            {{ Form::text('youtube', $siteSetting->youtube, ['class' => 'form-control mb-2']) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            {{ Form::label('pinterest', 'Pinterest Link',['class' => 'form-control-label']) }}
                            {{ Form::text('pinterest', $siteSetting->pinterest, ['class' => 'form-control mb-2']) }}
                        </div>
                    </div>
                </div>
